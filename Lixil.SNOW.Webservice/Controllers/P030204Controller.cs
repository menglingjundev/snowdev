...
namespace Lixil.SNOW.Webservice.Controllers
{
	...
	public class P030204Controller : ControllerBase
	{
		/// <summary>
		/// Snow業者マスタの取得
		/// </summary>
		...
		[HttpGet(Name = "SelGyosyaData/{drpBumon}/{txtGyosyaName}/{txtCanaName}")]
		public List<GYOSYA> SelGyosyaData(string drpBumon, string txtGyosyaName, string txtCanaName)
		{
			...
			result = new P030204_BizLogic().SelGyosyaData(drpBumon, txtGyosyaName, txtCanaName);
			return result;
		}
