...
namespace Lixil.SNOW.Webservice.Controllers
{
    ...
    public class P130310Controller : ControllerBase
    {
        /// <summary>
        /// 採番の種類マスタを登録
        /// </summary>
        ...
        [HttpPost(Name = "UpdSaibanSyurui/{saibanSyurui}/{saibanBunruiFlg1}/{saibanBunruiFlg2}/{saibanBunruiFlg3}/{saibanBunruiFlg4}/{saibanBunruiFlg5}/{saibanRirekiFlg}/{saibanGamenFlg}/{deleteFlg}/{userId}")]
        ...
        {
            int result = new P130310_BizLogic().UpdSaibanSyurui(saibanSyurui, saibanBunruiFlg1, saibanBunruiFlg2, saibanBunruiFlg3, saibanBunruiFlg4, saibanBunruiFlg5, saibanRirekiFlg, saibanGamenFlg,deleteFlg, userId);
