...
namespace Lixil.Snow.BizLogic
{
	...
	/// 部品更新属性チェック(浴室)
	/// </summary>
	public class B051401_BizLogic
	{

		//SQL文実行用
		private B051401_DataAccess da;

		public B051401_BizLogic()
		{
			da = new B051401_DataAccess();
		}
	...
	//		var @params = Utilities.ConfigFileCommon.GetParams(new[] { partNumberEntity, bumonCdEntity }.ToList,
