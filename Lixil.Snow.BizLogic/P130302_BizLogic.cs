...
namespace Lixil.Snow.BizLogic
{
    ...
    /// 採番の種類マスタのデータアクセス
    /// </summary>
    public class P130302_BizLogic
    {

        //SQL文実行用
        private P130302_DataAccess da;

        public P130302_BizLogic()
        {
            da = new P130302_DataAccess();
        }
        ...
        public int InsSaibanBunrui(string saibanSyurui, string burui1, string burui2, string burui3, string burui4, string burui5, string maeMoji, string kijunbiFlg, int sqlLength, long sqlStart, long sqlEnd, string overFlg, string userId)
        {
            ...
            int result = da.InsSaibanBunrui(saibanSyurui, burui1, burui2, burui3, burui4, burui5, maeMoji, kijunbiFlg, sqlLength, sqlStart, sqlEnd, overFlg, userId);
            da.Close();
            return result;
        }
    }
